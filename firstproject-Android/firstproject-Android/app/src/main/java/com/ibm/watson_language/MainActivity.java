package com.ibm.watson_language;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        speechService.setUsernameAndPassword(getString(R.string.texttospeechUsername),
                getString(R.string.texttospeechPassword));

        translationService = new LanguageTranslator();
        translationService.setEndPoint(getString(R.string.languagetranslatorUrl));
        translationService.setUsernameAndPassword(getString(R.string.languagetranslatorUsername),
                getString(R.string.languagetranslatorPassword));
